...
A random thought: Can destination city marketsbe representedas THiessen polygons and the distance to the nearest airport be mapped/calculated? 
```{r}
...
delay_by_competitiveness <- competitive_flights_delayed %>%
